...
?>
	<div id="primary" class="content-area">
		<div class="home-slider slider">
			<div class="slide slide-prayer" id="home-slide-1" style="background-image: url(<?php echo get_site_url(); ?>/wp-content/uploads/2019/08/home-banner-2560px-e1566397314330.jpg);">
			...
			<div class="slide slide-ashley" id="home-slide-2" style="background-image: url(<?php echo get_site_url(); ?>/wp-content/uploads/2020/02/Photo65-scaled.jpg);">
				<div class="single-column">
					<p>
